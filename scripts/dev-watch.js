...
sourceWatcher
  .on('change', (filePath) => {
    console.log(`[watch] Source file changed: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  })
  .on('add', (filePath) => {
    console.log(`[watch] Source file added: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  })
  .on('unlink', (filePath) => {
    console.log(`[watch] Source file removed: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  });
...
templateWatcher
  .on('change', (filePath) => {
    console.log(`[watch] Template file changed: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  })
  .on('add', (filePath) => {
    console.log(`[watch] Template file added: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  })
  .on('unlink', (filePath) => {
    console.log(`[watch] Template file removed: ${path.relative(process.cwd(), filePath)}`);
    debouncedBuild();
  });
